		...
		<div id="main-carousel-component" class=" carousel carousel-dark slide" data-bs-ride="carousel">
			...
			<div class="carousel-inner container">
				...
				<div class="carousel-item" data-bs-interval="2000">
					<div class="row align-items-center">
							<div class="col-12 text-center text-lg-start col-lg-4 animate__animated animate__fadeInUp animate__delay-05s">
								<h2 class="text-primary fw-bold">Centros educativos de apoyo</h2>
								<p clas="text-muted">Encuentra un centro en donde puedas solicitar una asesoría presencial</p>
								<a href="#" class="btn btn-primary d-inline-block ">Buscar centros</a>
							</div>
							<div class="col-12 col-lg-8 d-flex justify-content-center animate__animated animate__fadeIn animate__delay-1s">
				...
				<div class="carousel-item">
					<div class="row align-items-center">
						<div class="col-12 text-center text-lg-start col-lg-4 animate__animated animate__fadeInUp animate__delay-05s  ">
							<h2 class="text-primary fw-bold">Biblioteca online</h2>
							<p clas="text-muted">Libros de texto, documentos, videos y podcast</p>
							<a href="#" class="btn btn-primary d-inline-block">Ir a la biblioteca</a>
						</div>
						<div class="col-12 col-lg-8 d-flex justify-content-center animate__animated animate__fadeIn  animate__delay-1s">
							<div class="carousel-image-container" style="background: linear-gradient(356.69deg, #FFFFFF 2.57%, rgba(255, 255, 255, 0) 18.64%), linear-gradient(175.76deg, #FFFFFF 7.01%, rgba(255, 255, 255, 0) 29.23%), linear-gradient(263.72deg, #FFFFFF 4.96%, rgba(255, 255, 255, 0) 45.27%), linear-gradient(91.03deg, #FFFFFF 8.2%, rgba(255, 255, 255, 0) 56.36%), url(https://images.pexels.com/photos/8466775/pexels-photo-8466775.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260);"></div>
